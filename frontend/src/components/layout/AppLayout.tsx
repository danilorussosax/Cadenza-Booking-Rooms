  ...
  return (
    <div className="flex min-h-dvh bg-muted/30">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="safe-pt safe-pl safe-pr sticky top-0 z-30 flex min-h-14 items-center gap-2 border-b bg-background/80 px-7 backdrop-blur-sm sm:min-h-16 sm:gap-3 sm:px-7 lg:min-h-20 lg:px-8">
          <Button
            variant="ghost"
            size="icon"
            className="lg:hidden"
        ...
        <main
          id="main-content"
          tabIndex={-1}
          className="safe-pl safe-pr flex-1 px-7 py-4 pb-24 focus-visible:outline-hidden sm:px-7 sm:py-6 lg:px-8 lg:py-8 lg:pb-8"
        >
          <motion.div
