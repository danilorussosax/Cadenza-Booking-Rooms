...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/login-email.png}\caption*{Form email + password}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/complete-profile.png}\caption*{Pagina di completamento profilo}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/dashboard-overview.png}\caption*{Dashboard — vista calendario "1 giorno" (default)}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/booking-page.png}\caption*{Pagina di prenotazione — selezione aula + slot 30 min}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/my-bookings.png}\caption*{Le mie prenotazioni — tab future, passate, annullate}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/rooms-grouped.png}\caption*{Pagina Aule — sezioni espandibili per edificio}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/monteore-docente-banner.png}\caption*{Banner deroga Monte Ore personalizzata}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/instruments-overview.png}\caption*{Inventario strumenti — vista catalogo}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/announcements-overview.png}\caption*{Bacheca avvisi — griglia di card con badge audience}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/profile-page.png}\caption*{Pagina Profilo — anagrafica e preferenze}\end{figure}
...
\begin{figure}[H]\centering\includegraphics[width=0.95\linewidth]{screenshots/profile-app-icon.png}\caption*{Profilo — card "Aggiungi a Home" (PWA)}\end{figure}
