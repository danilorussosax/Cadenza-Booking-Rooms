#!/usr/bin/env python3
"""Build aulabook_promo.mp4 from slides_pdf/*.png (16 slides) using ffmpeg-static."""
...
OUT_PATH = os.path.join(ROOT, "aulabook_promo.mp4")
...
def main():
    ...
    for i in range(n):
        ...
        chains.append(
            ...
            f"pad=2400:1350:(ow-iw)/2:(oh-ih)/2:color=#0b1733,setsar=1,"
